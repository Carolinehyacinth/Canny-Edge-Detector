...
#include "systemc.h"
clock_t Tstart,Tstart1,Tstart2,Tstart3,Tstart4,Tstart5,Tstart6,Tstart7,Tstart8;
clock_t Tstop,Tstop1,Tstop2,Tstop3,Tstop4,Tstop5,Tstop6,Tstop7,Tstop8;
...
SC_MODULE(Receive_Image)
{
	...
	void main()
	{
	   while(1)
	   {
	   	  ...
	   	  Tstart1 = clock();
	      Tstop1 = clock();
	      T1 += (double)(Tstop1-Tstart1);
	      //printf("Receive_Image: %f sec.\n", T1);
	      ImgOut.write(Image);
	   }
	}
	...
	void main(void)
	{
	   ...
	   ****************************************************************************/
	   while(1)
	   {
		  ...
		  Tstop2 = clock();
	      T2 += (double)(Tstop2-Tstart2);
	      //printf("Gaussian_Kernel: %f sec.\n", T2);
	...
	*******************************************************************************/
	...
	void main(void)
	{
	   while(1)
	   {
	      ...
	      Tstop5 = clock();
	      T5 += (double)(Tstop5-Tstart5);
	      //printf("Derivative_X_Y: %f sec.\n", T5);
	      XOut1.write(delta_x);
	      XOut2.write(delta_x);
	      YOut1.write(delta_y);
	      YOut2.write(delta_y);
	...
	*******************************************************************************/
	...
	void main(void)
	{
	   while(1)
	   {
	      ...
	      Tstop6 = clock();
	      T6 += (double)(Tstop6-Tstart6);
	      //printf("Magnitude_X_Y: %f sec.\n", T6);
	...
	*******************************************************************************/
	...
	void main(void)
	{
	   ...
	   while(1)
	   {
	      ...
	      Tstop7 = clock();
	      T7 += (double)(Tstop7-Tstart7);
	      //printf("Non_Max_Supp: %f sec.\n", T7);
	...
	*******************************************************************************/
	...
	void main(void)
	{
	   while(1)
	   {
	      ...
	      Tstop8 = clock();
	      T8 += (double)(Tstop8-Tstart8);
	      //printf("Apply_Hysteresis: %f sec.\n", T8);
...
int sc_main(int argc, char* argv[])
{
	...
	T4 = (double)T4/CLOCKS_PER_SEC;
	T5 = (double)T5/CLOCKS_PER_SEC;
	T6 = (double)T6/CLOCKS_PER_SEC;
	T7 = (double)T7/CLOCKS_PER_SEC;
	T8 = (double)T8/CLOCKS_PER_SEC;
	printf("Whole time: %f sec.\n", T);
	printf("Receive_Image: %f sec.\n", T1);
	printf("Gaussian_Kernel: %f sec.\n", T2);
	printf("BlurX: %f sec.\n", T3);
	printf("BlurY: %f sec.\n", T4);
