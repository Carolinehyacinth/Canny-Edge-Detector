...
{
	sc_out<int> windowsize;
	sc_out<F_2_IMAGE> kernel;
	//sc_fifo_out<F_2_IMAGE> Kernel;
	//sc_fifo_out<int> Windowsize;
	//sc_fifo_out<int> Center;
	//F_2_IMAGE kernel;
...
SC_MODULE(BlurX)
{
	...
	sc_in<F_2_IMAGE> kernel;
	sc_in<int> windowsize;
	IMAGE image;
	F_1_IMAGE tempim;
...
SC_MODULE(Gaussian_Smooth)
{
	...
	BlurX blurX;
	BlurY blurY;
    sc_signal<int> windowsizesign;
    sc_signal<int> kernelsign;
	...
	,blurY("blurY")
	{
       gauss.windowsize(windowsizesign);
       gauss.kernel(kernelsign);
	   receive.ImgIn.bind(ImgIn);
	   receive.ImgOut.bind(channel_1);
	   blurX.ImgIn.bind(channel_1);
	   blurX.windowsize(windowsizesign);
	   blurX.kernel(kernelsign);
	   blurX.TempimOut.bind(channel_2);
	   blurY.Tempim.bind(channel_2);
	   blurY.windowsize(windowsizesign);
	   blurY.kernel(kernelsign);
